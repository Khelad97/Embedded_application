...
# 12 "ecu/ecu_lcd/ecu_lcd.h"
# 1 "ecu/ecu_lcd/../../mcal/mcal_gpio/mcal_gpio.h" 1
# 10 "ecu/ecu_lcd/../../mcal/mcal_gpio/mcal_gpio.h"
...
void lcd_intialize(const lcd_t *lcd) {
    ...
    gpio_port_direction_intialize(lcd->lcd_data_port, 0X00);
    gpio_port_write_value(lcd->lcd_data_port, 0X00);
...
void lcd_send_custome_char(const lcd_t *lcd, uint8_t row, uint8_t coulmn, const char arr[], uint8_t pos) {
    ...
    uint8_t l_counter = 0;
    lcd_send_command(lcd, 0x40 + (pos * 8));
