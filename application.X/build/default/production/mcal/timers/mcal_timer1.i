...
# 12 "mcal/timers/mcal_timer1.h" 2
...
# 13 "mcal/timers/mcal_timer1.h" 2
...
void TMR2_ISR(void);
void TMR3_ISR(void);
# 14 "mcal/timers/mcal_timer1.h" 2
...
static __attribute__((inline)) void timer1_select_mode(const timer1_t *timer_obj){
    if(timer_obj->timer_register_mode == 1){
        (T1CONbits.RD16 = 1);
    }
    else{
        (T1CONbits.RD16 = 0);
...
static __attribute__((inline)) void timer1_select_clock_source(const timer1_t *timer_obj){
    if(timer_obj->timer_counter_mode == 1){
        (T1CONbits.TMR1CS = 0);
    }
    else{
        (T1CONbits.TMR1CS = 1);
...
static __attribute__((inline)) void timer1_interrupt_config(const timer1_t *timer_obj){
    if(timer_obj->timer_interrupt_mode == 1){
...
static __attribute__((inline)) void timer1_prescaler_control(const timer1_t *timer_obj){
...
ret_status timer1_read_timer(uint16_t *timer_value){
    ret_status ret = R_OK;
    uint8_t read_tmr1l = ((uint8_t)0U), read_tmr1h = ((uint8_t)0U);
    read_tmr1l = TMR1L;
    read_tmr1h = TMR1H;
