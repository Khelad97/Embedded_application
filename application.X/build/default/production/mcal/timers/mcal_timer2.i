...
# 2 "<built-in>" 2
# 1 "mcal/timers/mcal_timer2.c" 2


# 1 "mcal/timers/mcal_timer2.h" 1
# 12 "mcal/timers/mcal_timer2.h"
...
# 12 "mcal/timers/mcal_timer2.h" 2
...
# 13 "mcal/timers/mcal_timer2.h" 2
...
# 3 "mcal/timers/mcal_timer2.c" 2


static void (*TMR2_InterruptHandler)(void) = ((void*)0);
volatile static uint8_t timer2_preload;

static __attribute__((inline)) void timer_prescaler_value(const timer2_t *timer2) {
...
static __attribute__((inline)) void timer_postscaler_value(const timer2_t *timer2) {
    timer2_preload = timer2->timer_postscaler_value;
    uint8_t val;

    val = timer2_preload % 2;
    (T2CONbits.T2OUTPS0 = val);
    timer2_preload = timer2_preload / 2;


    val = timer2_preload % 2;
    (T2CONbits.T2OUTPS1 = val);
    timer2_preload = timer2_preload / 2;


    val = timer2_preload % 2;
    (T2CONbits.T2OUTPS2 = val);
    timer2_preload = timer2_preload / 2;


    val = timer2_preload % 2;
    (T2CONbits.T2OUTPS3 = val);
    timer2_preload = timer2_preload / 2;
}


static __attribute__((inline)) void timer_interrupt_mode(const timer2_t *timer2) {
    if (timer2->timer_interrupt_mode == 1) {
