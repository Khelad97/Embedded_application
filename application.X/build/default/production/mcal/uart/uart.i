...
# 11 "mcal/uart/uart.h"
# 1 "mcal/uart/../../std_types.h" 1
# 10 "mcal/uart/../../std_types.h"
...
# 12 "mcal/uart/../../std_types.h" 2
# 26 "mcal/uart/../../std_types.h"
typedef enum {
    R_NOK,
    R_OK
} ret_status;
# 11 "mcal/uart/uart.h" 2

# 1 "mcal/uart/../interrupt/mcal_usart_interrupt.h" 1
# 11 "mcal/uart/../interrupt/mcal_usart_interrupt.h"
# 1 "mcal/uart/../interrupt/mcal_interrupt_config.h" 1
# 11 "mcal/uart/../interrupt/mcal_interrupt_config.h"
...
# 11 "mcal/uart/../interrupt/mcal_interrupt_config.h" 2


# 1 "mcal/uart/../interrupt/../mcal_gpio/mcal_gpio.h" 1
# 13 "mcal/uart/../interrupt/../mcal_gpio/mcal_gpio.h"
...
# 13 "mcal/uart/../interrupt/../mcal_gpio/mcal_gpio.h" 2

# 1 "mcal/uart/../interrupt/../mcal_gpio/../../device_config.h" 1
# 14 "mcal/uart/../interrupt/../mcal_gpio/mcal_gpio.h" 2
# 24 "mcal/uart/../interrupt/../mcal_gpio/mcal_gpio.h"
typedef enum {
    PIN_LOW,
    PIN_HIGH
} pin_logic;
...
# 13 "mcal/uart/../interrupt/mcal_interrupt_config.h" 2
# 34 "mcal/uart/../interrupt/mcal_interrupt_config.h"
typedef enum{
    LOW_PRIORITY,
    HIGH_PRIORITY
}priority_config;
# 11 "mcal/uart/../interrupt/mcal_usart_interrupt.h" 2
...
static void (*EUSART_ErrorInterruptHandler)(void) = ((void*)0);
...
void EUSART_Initialize(const usart_t *usart_obj){
    ...
    usart_interrupt_enable(USART_INT_TX_DISABLE);

    usart_clear_tx_interrupt_flag();
    usart_clear_rx_interrupt_flag();
    EUSART_Mode_Select(usart_obj);
    EUSART_Receiver_Enable(usart_obj);
    EUSART_Transmit_Enable(usart_obj);
    EUSART_Baud_Rate_Calculation(usart_obj);
...
static void EUSART_Mode_Select(const usart_t *usart_obj){
    if(usart_obj->eusart_config.EUSART_sync_async_mode == 1){
        TXSTAbits.SYNC = 1;
    }
    else{
        TXSTAbits.SYNC = 0;
...
static void EUSART_Receiver_Enable(const usart_t *usart_obj){
    if(usart_obj->eusart_config.receiver_enable == 1){
...
static void EUSART_Transmit_Enable(const usart_t *usart_obj){
    if(usart_obj->eusart_config.transmit_enable == 1){
...
static void EUSART_Baud_Rate_Calculation(const usart_t *usart_obj){
    ...
    switch(usart_obj->baudrate_gen_gonfig){
        case BAUDRATE_ASYN_8BIT_lOW_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 0;
            temp = (((8000000UL / (float)(usart_obj->baudrate)) / 64) - 1);
            break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            temp = (((float)(8000000UL) / (float)(usart_obj->baudrate * 16)) - 1);
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            BAUDCONbits.BRG16 = 1;
            TXSTAbits.BRGH = 1;
            temp = (((float)(8000000UL) / (float)(usart_obj->baudrate * 4)) - 1);
            break;
