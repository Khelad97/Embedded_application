# 1 "mcal/interrupt/mcal_usart_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcal/interrupt/mcal_usart_interrupt.c" 2
...
# 11 "mcal/interrupt/mcal_usart_interrupt.h"
...
# 11 "mcal/interrupt/mcal_usart_interrupt.h" 2
...
# 8 "mcal/interrupt/mcal_usart_interrupt.c" 2


void usart_interrupt_enable(usart_int_t state){
    switch(state){
        case USART_INT_TX_ENABLE : PIE1bits.TX1IE = 1; break;
        case USART_INT_TX_DISABLE : PIE1bits.TX1IE = 0; break;
        case USART_INT_RX_ENABLE : PIE1bits.RC1IE = 1; break;
        case USART_INT_RX_DISABLE : PIE1bits.RC1IE = 0; break;
        default : ;
    }
}
