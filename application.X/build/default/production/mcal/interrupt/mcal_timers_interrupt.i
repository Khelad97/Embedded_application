# 1 "mcal/interrupt/mcal_timers_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcal/interrupt/mcal_timers_interrupt.c" 2
...
# 11 "mcal/interrupt/mcal_timers_interrupt.h"
...
# 11 "mcal/interrupt/mcal_timers_interrupt.h" 2
# 29 "mcal/interrupt/mcal_timers_interrupt.h"
void TMR0_ISR(void);
void TMR1_ISR(void);
void TMR2_ISR(void);
void TMR3_ISR(void);
# 8 "mcal/interrupt/mcal_timers_interrupt.c" 2
